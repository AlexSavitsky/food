  ...
  class MenuCard {
    ...
    render() {
      ...
      if (this.classes.length === 0) {
        ...
        this.classes.forEach((className) => element.className.add(className));
      }
...
function slider({
  ...
  const slides = document.querySelectorAll(slide),
    ...
    width = +window.getComputedStyle(slidesWrapper).width.replace(/\D/gi, "");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_1__["default"])(".timer", "2022-08-29");
